...
@Composable
fun ReorderLists(viewModel: PlanViewModel) {
            ...
            items(newTrips.value, key = {
                ...
                ReorderableItem(
                    ...
                    Card(
                        ...
                        border = BorderStroke(0.5.dp, color = Color.Black.copy(0.5f))
                    ) {
                        Row(
                            modifier = Modifier
                                .fillMaxWidth(),
                    ...
                    items(days.value) { day ->
                        Card(
                            ...
                            Column(
                                ...
                                Text(
                                    text = "Day $day",
                                    color = if (day == currentDay.value) MaterialTheme.colorScheme.tertiary
